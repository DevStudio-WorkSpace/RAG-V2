...
El proyecto reportó 92% de aciertos. Vayan a `scripts/generar_consultas_hito2.py` y lean cómo se fabricaron las 50 consultas con las que se midió ese 92%. 
...
| Entrega 3 | **AI_LOG.md** | Los prompts que usaron, como en los hitos anteriores. |
